      ...
      <header className="border-b dark:border-slate-800 bg-white/80 dark:bg-slate-950/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="font-bold text-slate-900 dark:text-white">GiveMetry<span className="text-emerald-600 dark:text-emerald-400">AI</span><sup className="text-[0.6em] font-normal text-slate-400">™</sup></span>
          </Link>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <div className="bg-white dark:bg-slate-800 rounded-xl p-8 shadow-sm border dark:border-slate-700">
            ...
            <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-2">GiveMetry<span className="text-emerald-600 dark:text-emerald-400">AI</span><sup className="text-[0.6em] font-normal text-slate-400">™</sup></h3>
            <p className="text-slate-600 dark:text-slate-400 text-sm">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
            ...
            <div className="col-span-2 md:col-span-1">
              <Link href="/" className="flex items-center gap-2 mb-4">
                ...
                <span className="font-bold dark:text-white">GiveMetry<span className="text-emerald-600 dark:text-emerald-400">AI</span><sup className="text-[0.6em] font-normal text-slate-400">™</sup></span>
              </Link>
