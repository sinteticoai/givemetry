      ...
      <header className="border-b dark:border-slate-800 bg-white/80 dark:bg-slate-950/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="font-[family-name:var(--font-inter)] text-2xl font-bold tracking-tight text-slate-900 dark:text-white">GiveMetry</span>
          </Link>
          ...
          <div className="max-w-3xl">
            ...
            <div className="space-y-12 mt-12">
              ...
              <section className="border-b dark:border-slate-800 pb-8">
                ...
                <p className="text-slate-600 dark:text-slate-300 leading-relaxed mb-4">
                  Our collection and use of personal information is governed by our <Link href="/privacy" className="text-emerald-400 dark:text-emerald-400 hover:underline">Privacy Policy</Link>, which is incorporated into these Terms by reference.
                </p>
                <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
              ...
              <section className="pb-8">
                ...
                <CalloutBox variant="neutral">
                  <ul className="text-slate-600 dark:text-slate-300 space-y-2 text-sm">
                    <li><strong>Email:</strong> <a href="mailto:legal@sintetico.ai" className="text-emerald-400 dark:text-emerald-400 hover:underline">legal@sintetico.ai</a></li>
