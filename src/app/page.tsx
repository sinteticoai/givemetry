        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold dark:text-white">GiveMetry<span className="text-emerald-600 dark:text-emerald-400">AI</span><sup className="text-[0.6em] font-normal text-slate-400">™</sup></span>
            </div>
